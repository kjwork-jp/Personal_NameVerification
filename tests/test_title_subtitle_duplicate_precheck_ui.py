...
class DuplicateQueryService:
    ...
    def list_names_for_title(self, title_id: int, role: str = "admin", *, include_deleted: bool = False) -> list[NameTitleLinkRow]:
    ...
    def list_subtitles(self, title_id: int, role: str = "admin", *, include_deleted: bool = False) -> list[SubtitleDetail]:
        _ = (role, include_deleted)
        if title_id != 1:
            return []
        return [
